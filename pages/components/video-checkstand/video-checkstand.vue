	...
	<!-- 		<text style="color: #f00;" v-else>{{sum}}</text> -->
		...
		<view class="way">
			...
			<view class="item">
				...
				<radio  color="#FED940" style="transform: scale(0.7);"
				@click="handleBalance" :checked="balanceWay"></radio>
			</view>
			<view class="item">
				<view>
				...
				<radio color="#FED940" style="transform: scale(0.7);"
				:checked="payWay" @click="handlePayWay"></radio>
			</view>
		</view>
		<!-- 支付密码 -->
		...
		<view class="btn" @click="handleOrder">
			<button 
			style="font-size: 30rpx;background: #FED940;color: #fff;">
			支付
			</button>
		</view>
	</view>
